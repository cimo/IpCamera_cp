...
--
-- Table structure for table `microservice_qunit`
--

DROP TABLE IF EXISTS `microservice_qunit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `microservice_qunit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `microservice_qunit`
--

LOCK TABLES `microservice_qunit` WRITE;
/*!40000 ALTER TABLE `microservice_qunit` DISABLE KEYS */;
/*!40000 ALTER TABLE `microservice_qunit` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `page` VALUES (1,'myPage',NULL,'App\\Controller\\MyPage\\MyPageProfileController::renderAction','1,',1,0,1,0,0,0,'-','-','0000-00-00 00:00:00','cimo','2019-01-07 17:47:45','Personal page.','personal, page','noindex, nofollow',0),(2,'home',NULL,'App\\Controller\\ControlPanel\\IpCameraController::renderAction','1,',1,1,2,1,0,0,'-','-','0000-00-00 00:00:00','cimo','2019-04-25 14:47:22','Website home page.','website, home, page','index, follow',0),(3,'registration',NULL,'App\\Controller\\RegistrationController::renderAction','1,',0,0,3,1,0,0,'-','-','0000-00-00 00:00:00','cimo','2019-01-07 19:05:15','User registration page.','user, registration, page','index, follow',0),(4,'recover_password',NULL,'App\\Controller\\RecoverPasswordController::renderAction','1,',0,0,4,1,0,0,'-','-','0000-00-00 00:00:00','cimo','2019-01-07 19:05:40','User recover password.','user, recover, password','index, follow',0),(5,'search',NULL,'App\\Controller\\SearchController::renderAction','1,',0,0,5,1,0,0,'-','-','0000-00-00 00:00:00','cimo','2019-01-07 19:07:47','Website content search','website, content, search','noindex, nofollow',0);
...
CREATE TABLE `setting` (
  ...
  `server_ssh_username` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `server_ssh_password` blob,
  `server_key_public` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `server_key_private` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `server_key_private_password` blob,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
