...
function Loader() {
    ...
    self.create = function(type) {
        if (type === "image")
            $("<div id=\"loader_request\" class=\"display_none shadow\"><img src=\"" + window.url.root + "/Resources/public/images/templates/" + window.setting.template + "/loader_request.gif\" alt=\"loader_request.gif\"/></div>").appendTo("body");
